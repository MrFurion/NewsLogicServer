...
Сервер содержит модули:
* Api - отвечает за предоставление endpoints  для взаимодействия с сервером.  
...
* 20 Не реализован кэш провайдер Redis. Остальное по пункту реализовано.
* 22, 24 Не реализованы.
